...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _affiliations__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./affiliations */ \"./js/affiliations.js\");\n/* harmony import */ var _luna__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./luna */ \"./js/luna.js\");\n\n\ndocument.getElementById('verify').addEventListener('click', function (event) {\n  var cardNumber = document.getElementById('input').value;\n  event.preventDefault();\n\n  if (Object(_luna__WEBPACK_IMPORTED_MODULE_1__[\"default\"])(cardNumber)) {\n    document.getElementById('input').classList.add('valid');\n    document.getElementById('input').classList.remove('invalid');\n  } else {\n    document.getElementById('input').classList.add('invalid');\n    document.getElementById('input').classList.remove('valid');\n  }\n\n  Object(_affiliations__WEBPACK_IMPORTED_MODULE_0__[\"sysAffiliation\"])(cardNumber);\n});\n\n//# sourceURL=webpack:///./js/app.js?");
